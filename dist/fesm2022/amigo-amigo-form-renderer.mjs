...
class AmigoFormComponent {
    ...
    buttonLoading = {};
    buttonFeedback = {};
    constructor(formService, cdr, zone, apiExec) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.6", ngImport: i0, type: AmigoFormComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: AmigoFormService }, { type: i0.ChangeDetectorRef }, { type: i0.NgZone }, { type: AmigoApiExecutionService }], propDecorators: { formId: [{
                type: Input
            }], schema: [{
                type: Input
            }], initialValue: [{
